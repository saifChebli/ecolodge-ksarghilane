  ...
  return (
    ...
    >
      <motion.div
        ...
        className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-10"
      >
        {/* Text + Image */}
        ...
        <div className="flex justify-center gap-6 mt-18">
          <button
            ...
            className="text-xl px-4 py-2 border rounded-full hover:bg-black hover:text-white transition"
          >
            <ArrowLeft />
          </button>
          <button
          ...
          >
           <Swiper
            ...
            navigation={true}
            className="rounded-3xl overflow-hidden shadow-lg mySwiper no-arrows h-full"
          >
            {images.map((img, i) => (
              <SwiperSlide key={i}>
                <Image
