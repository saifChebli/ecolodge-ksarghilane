    ...
    <div className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex justify-end">
                <button onClick={updateEmail} className="bg-[#1E40AF] cursor-pointer text-white px-6 py-2 rounded-md hover:bg-blue-700 transition-colors duration-200 flex items-center space-x-2">
      ...
      {/* Update Password */}
      {
        ...
        <div className="flex justify-end mt-4">
          ...
          <button onClick={updatePassword} className="bg-[#1E40AF] cursor-pointer text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors duration-200 flex items-center space-x-2">
